                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive browser_users">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/logos/chrome.png') }}" alt height="24" class="me-2">Chrome</td>
                                            ...
                                            <!--end tr-->
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/logos/micro-edge.png') }}" alt height="24" class="me-2">Microsoft
                                                    Edge</td>
                                            ...
                                            <!--end tr-->
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/logos/in-explorer.png') }}" alt height="24" class="me-2">Internet-Explorer</td>
                                            ...
                                            <!--end tr-->
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/logos/opera.png') }}" alt height="24" class="me-2">Opera</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 align-self-center">
                                        <div class="d-flex align-items-center my-3">
                                            <img src="{{ asset('admin-assets/images/flags/us_flag.jpg') }}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                        ...
                                        <!--end media-->
                                        <div class="d-flex align-items-center my-3">
                                            <img src="{{ asset('admin-assets/images/flags/germany_flag.jpg') }}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                            <div class="flex-grow-1 ms-2">
                                        ...
                                        <!--end media-->
                                        <div class="d-flex align-items-center my-3">
                                            <img src="{{ asset('admin-assets/images/flags/spain_flag.jpg') }}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                            <div class="flex-grow-1 ms-2">
                                        ...
                                        <!--end media-->
                                        <div class="d-flex align-items-center my-3">
                                            <img src="{{ asset('admin-assets/images/flags/baha_flag.jpg') }}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                            <div class="flex-grow-1 ms-2">
