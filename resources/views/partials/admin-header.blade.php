            ...
            <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                    ...
                    <li class="mx-3 welcome-text">
                        <h3 class="mb-0 fw-bold text-truncate">Welcome to Pitara Programming Admin Panel!</h3>
                        <h6 class="mb-0 fw-normal text-muted text-truncate fs-14">Here's your project overview this
                            week.</h6>
                    </li>
                </ul>
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin-assets/images/flags/us_flag.jpg') }}" alt=""
                                    height="15" class="me-2">English</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin-assets/images/flags/spain_flag.jpg') }}" alt=""
                                    height="15" class="me-2">Spanish</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin-assets/images/flags/germany_flag.jpg') }}" alt=""
                                    height="15" class="me-2">German</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('admin-assets/images/flags/french_flag.jpg') }}" alt=""
                                    ...
                                    <div class="tab-pane fade show active" id="All" role="tabpanel"
                                        ...
                                        <a href="#" class="dropdown-item py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                                    <h6 class="my-0 fw-normal text-dark fs-13">Your project is uploaded
                                                    </h6>
                                                    <small class="text-muted mb-0">Details about the new code
                                                        template.</small>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </a><!--end-item-->
                                        ...
                                        <a href="#" class="dropdown-item py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                                    <h6 class="my-0 fw-normal text-dark fs-13">Meeting with developers
                                                    </h6>
                                                    <small class="text-muted mb-0">Discussing new API
                                                        integrations.</small>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </a><!--end-item-->
                                        ...
                                        <a href="#" class="dropdown-item py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                                    <h6 class="my-0 fw-normal text-dark fs-13">API task completed</h6>
                                                    <small class="text-muted mb-0">Details about the new
                                                        endpoint.</small>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </a><!--end-item-->
                                        ...
                                        <a href="#" class="dropdown-item py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                                    <h6 class="my-0 fw-normal text-dark fs-13">New project approved
                                                    </h6>
                                                    <small class="text-muted mb-0">Details about the mobile app
                                                        template.</small>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </a><!--end-item-->
                                        ...
                                        <a href="#" class="dropdown-item py-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                                    <h6 class="my-0 fw-normal text-dark fs-13">Payment processed</h6>
                                                    <small class="text-muted mb-0">Details about the recent
                                                        transaction.</small>
                                                </div><!--end media-body-->
                                            </div><!--end media-->
                                        </a><!--end-item-->
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                    ...
                                    <small class="text-muted mb-0">{{ Auth::user()->is_admin ? 'Platform Administrator' : 'User' }}</small>
                                </div><!--end media-body-->
                            </div>
